...
let articles = [
  {
    ...
    price: 29.95,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/47400/47435_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 38.0,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/46700/46720_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 25.49,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/27300/27303_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 25.0,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/43200/43212_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 12.0,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/45700/45759_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 49.95,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/46600/46667_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 20.0,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/40800/40804_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 19.95,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/47500/47500_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 29.95,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/43000/43021_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 39.95,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/25800/25893_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 19.99,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/26500/26530_1_360px.jpg",
    description:
  ...
  },
  {
    ...
    price: 15.49,
    imageUrl:
      "https://www.uncommongoods.com/images/articles/19000/19079_1_360px.jpg",
    description:
    ...
    shipping:
      "Most of our articles are in stock and will ship quickly. Orders for in-stock articles placed before 5pm ET Monday through Friday, excluding Federal holidays, will ship in the US: \r\n ECONOMY SHIPPING: within 8 days, arriving no later than the 9th business day after the order was placed. STANDARD SHIPPING: within 4 days, arriving 5 business days after the order was placed. PREFERRED SHIPPING: within 2 days, arriving 3 business days after the order was placed. EXPEDITED SHIPPING: within 1 day, arriving 2 business days after the order was placed. EXPRESS SHIPPING: will ship the same day and arrive 1 business day later."
  }
];
...
server.get("/articleById/:id", (req, res) => {
  const { id } = req.params;
  const findarticleById = article => {
    return article.id == id;
  };
  const foundArticle = articles.find(findArticleById);
  if (!foundArticle) {
    return sendUserError("No article found by that ID", res);
  } else {
...
server.post("/articles", (req, res) => {
  ...
  const newArticle = { name, price, imageUrl, description, shipping, id: articleId };
  if (!name || !price || !description) {
    return sendUserError(
      "Ya gone did goofed! Name/Price/Description are all required to create an article in the article DB.",
      res
    );
  }
  const findArticleByName = article => {
    return article.name === name;
  };
  if (articles.find(findArticleByName)) {
    return sendUserError(
      `Ya gone did goofed! ${name} already exists in the article DB.`,
      res
    );
  }
...
server.put("/articles/:id", (req, res) => {
  ...
  if (!foundArticle) {
    ...
    if (name) foundArticle.name = name;
    if (price) foundArticle.price = price;
    if (imageUrl) foundArticle.imageUrl = imageUrl;
    if (description) foundArticle.description = description;
    if (shipping) foundArticle.shipping = shipping;
    res.json(articles);
  }
});
...
server.delete("/articles/:id", (req, res) => {
  ...
  if (foundArticle) {
    const ArticleRemoved = { ...foundArticle };
    articles = articles.filter(article => article.id != id);
    res.status(200).json(articles);
  } else {
    sendUserError("No article by that ID exists in the article DB", res);
  }
});
